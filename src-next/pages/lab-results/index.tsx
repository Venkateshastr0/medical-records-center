...
import { MagnifyingGlassIcon, PlusIcon, PencilIcon, EyeIcon, BeakerIcon, UserIcon, CalendarIcon, TrashIcon } from '@heroicons/react/24/outline'
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <MagnifyingGlassIcon className="text-gray-400 absolute left-3 top-3" style={{ width: '1.25rem', height: '1.25rem' }} />
                    <input
                      type="text"
                        ...
                        <tr key={result.id} className="table-row">
                          ...
                          <td className="table-cell">
                            <div className="flex flex-col">
                              <span>{mounted ? new Date(result.test_date).toLocaleDateString() : ''}</span>
                              {result.result_date && (
                                <span className="text-xs text-gray-500">
                                  Result: {mounted ? new Date(result.result_date).toLocaleDateString() : ''}
                                </span>
                              )}
                            </div>
                          </td>
